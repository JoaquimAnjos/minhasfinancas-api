...
import com.gestaofinanceira.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.gestaofinanceira.minhasfinancas.api.dto.LancamentoDTO;
...
public class LancamentoResource {
	// os atributos com final vão ser obrigatoriamente inicializados no construtor
...
//	}
	...
	public ResponseEntity buscar(
			//@RequestParam java.util.Map<String,String> params outra maneira de se fazer
		...
		if(!usuario.isPresent()) {
			return ResponseEntity.badRequest().body("Não foi possível realizar a consulta. Usuário não encontrado na base de Dados.");
		} else {
